...
public class SecondActivity extends MainActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        ((TextView)findViewById(R.id.textViewRender)).setText((getIntent().getStringExtra("docu")));
        ((TextView)findViewById(R.id.textViewRender2)).setText((getIntent().getStringExtra("nom")));
